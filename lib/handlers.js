...
handlers.index = (data, callback) => {
    ...
    if (data.method.toUpperCase() === 'GET') {
        ...
        let templateData = {
            ...
            'head.description': 'We offer free, simple uptime monitoring to end users',
            'body.class': 'index'
        };
        ...
        if (trimmedAssetName.length > 0) {
            ...
            helpers.getStaticAsset(trimmedAssetName, (err, data) => {
                if (!err && data) {
                    ...
                    if (trimmedAssetName.indexOf('.icon') > -1) {
                        contentType = 'favicon';
                    }
                    // Callback the data
...
handlers._checks.post = (data, callback) => {
    ...
    debug(protocol, url, method, successCodes, timeoutSeconds);
